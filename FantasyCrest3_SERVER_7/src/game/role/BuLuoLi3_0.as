package game.role
{
   ...
   public class BuLuoLi3_0 extends GameRole
   {
      
      private var _buff:AttributeChangeBuff;
      
      public function BuLuoLi3_0(roleTarget:String, xz:int, yz:int, pworld:World, fps:int = 24, pscale:Number = 1, troop:int = -1, roleAttr:RoleAttributeData = null)
      {
      ...
      override public function onSUpdate() : void
      {
         ...
         trace("增幅：",_buff.changeData.power);
      }
   }
}
