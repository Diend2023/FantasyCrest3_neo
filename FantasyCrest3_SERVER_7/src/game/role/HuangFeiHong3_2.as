package game.role
{
   ...
   public class HuangFeiHong3_2 extends GameRole
   {
      ...
      public function HuangFeiHong3_2(roleTarget:String, xz:int, yz:int, pworld:World, fps:int = 24, pscale:Number = 1, troop:int = -1, roleAttr:RoleAttributeData = null)
      {
