package game.role
{
   ...
   public class GuiJianShi3_0 extends GameRole
   {
      ...
      public function GuiJianShi3_0(roleTarget:String, xz:int, yz:int, pworld:World, fps:int = 24, pscale:Number = 1, troop:int = -1, roleAttr:RoleAttributeData = null)
      {
      ...
      {
         super.onSUpdate();
         _buff.changeData.power = (1 - this.attribute.hp / this.attribute.hpmax) * 300;
