package game.role
{
   ...
   public class Hchq3_0 extends FlyRole
   {
      
      public var _flyNumber:int = 0;
      
      public function Hchq3_0(roleTarget:String, xz:int, yz:int, pworld:World, fps:int = 24, pscale:Number = 1, troop:int = -1, roleAttr:RoleAttributeData = null)
      {
